...
typedef std::function < double( const lsd::variable *, lsd::object * ) > eq_funcT;
 ...
 *************************************************************/
	class equation							// simulation model equation class
	{
		public:								// methods used in equations and GUI
			// equation methods for direct access
			...
			double _ran1_( long *unused = 0 );// 0-1 uniform draw
		...
		private:							// methods only used in equations
			...
			// equation methods used by macros
			...
			eq_mapT _eq_map_;				// fast equation look-up map
		...
		protected:							// methods used also by class simulation
			simulation *_sim_;				// derived class pointer
#ifndef _NW_
 ...
 *************************************************************/
	class simulation : public equation		// simulation container class
	{
		...
		public:
			...
			std::mutex obj_list_lck;		// lock object list for parallel manipulation
		...
		private:
			...
			std::atomic < int > alaplErrCnt, bernoErrCnt, betaErrCnt, binomErrCnt, cauchErrCnt, chisqErrCnt, expErrCnt, fishErrCnt, gammaErrCnt, geomErrCnt, lnormErrCnt, normErrCnt, paretErrCnt, poissErrCnt, studErrCnt, weibErrCnt;
