...
void lsd::object::report( void )
{
	...
	Tcl_LinkVar( gui::interp, "dsc", ( char * ) &dsc, TCL_LINK_BOOLEAN );
	...
	cmd( "ttk::checkbutton .w.g.opt.dsc -text \"Description\" -variable dsc" );
	...
	cmd( "pack .w.g.opt.dsc .w.g.opt.extra .w.g.opt.obs .w.g.opt.ini .w.g.opt.detail -anchor w" );
	...
	cmd( "progressbox .prep \"Creating Report\" \"Report generation steps\" \"Step\" %d { set stop true } \".\" \"Element\" $nElem", dsc + extra + obs + ini + detail );
