...
sprintf( msg, "label .f.com.nvar -text \"Series = %d\" -width 17", num_var );
cmd( inter, msg );
sprintf( msg, "label .f.com.ncas -text \"Cases = %d\" -width 17", num_c );
cmd( inter, msg );
cmd( inter, "label .f.com.pad -width 10" );
cmd( inter, "label .f.com.selec -width 36" );
