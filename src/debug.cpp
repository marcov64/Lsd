...
case 22:
	...
	cmd( "text $n.t -width 15 -yscrollcommand \"$n.yscroll set\" -wrap word -font \"$font_normal\"" );
...
cmd( "text $in.t -width 20 -height 30 -yscrollcommand \"$in.yscroll set\" -wrap word -font \"$font_normal\"" ); 
