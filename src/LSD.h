...
#define _LSD_DATE_ "March 16 2026"	 // __DATE__
...
#define LMM_OPTIONS_TYPE { 'p', 'p', \
						   ...
						   'a', 'a', 'p', 'p', \
						   'a', 'g', 'p' }
#define LSD_TERM_NUM 5
#define LSD_TERM_SRC { "LSDterm.cpp", "lsd_init.h", "lsd_head.h", "fun_head.h", "fun_head_fast.h" }
