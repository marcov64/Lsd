...
*/
	...
	v[1]=V("Available_Financial_Assets");
	v[2]=V("Available_Debt");
	v[3]=VL("Stock_Debt", 1);
	v[4]=VL("Stock_Financial_Assets", 1);
	v[5]=max(v[0],-v[4]);
	v[6]=V("Interest_Rate");
...
EQUATION("Available_Financial_Assets")
/*
...
*/
	...
	v[2]=VL("Stock_Financial_Assets",1);
	v[3]=v[2]-(v[1]*v[0]);//can be positive or negative
RESULT(v[3])


EQUATION("Available_Debt")
/*
...
*/
	...
	v[2]=VL("Stock_Debt",1);
	v[3]=VL("Stock_Financial_Assets",1);
...
*/
	v[0]=V("Stock_Debt");                                                              //firm's stock of debt 
	v[1]=V("Capital");                                                                 //firm fisical capital
	v[2]=VL("Stock_Financial_Assets",1);                                               //firm's stock of financial assets in the last period
...
*/
	...
	for (v[1]=1; v[1]<=v[0]; v[1]=v[1]+1)												//from 0 to investment period-1 lags
		{
		v[2]=VL("Debt_Rate", v[1]);														//computates firm's debt rate of the current lag
...
EQUATION("Stock_Financial_Assets")
/*
Current Value of the stock of financial assets
*/
	v[0]=V("Flow_Financial_Assets");
	v[1]=VL("Stock_Financial_Assets", 1);
	v[2]=v[0]+v[1];
	v[3]=max(0, v[2]);
RESULT(v[3])
...
*/
	v[0]=VL("Stock_Debt", 1);                                                         //firm's stock of debt in the last period
	v[1]=V("Interest_Rate_Firm");                                                     //interest rate paid by the firm
	v[2]=VL("Stock_Financial_Assets", 1);                                             //firm's stock of financial assets in the last period
	v[3]=V("Interest_Rate");                                                          //return rate on financial assets
...
*/
	v[0]=V("Retained_Profits");
	v[1]=V("Available_Debt");
	v[2]=V("Available_Financial_Assets");
	v[3]=V("Funds"); 																//v[0]+v[1]+v[2]
	v[4]=V("Desired_Expansion_Investment_Expenses");
	v[5]=V("Effective_Expansion_Investment_Expenses");
	v[6]=V("Available_Funds_Replacement");
	v[7]=V("Replacement_Expenses");
	v[8]=V("Available_Funds_After_Replacement");
	v[9]=v[5]+v[7]; 																//total effective investment expenses
	v[10]=VL("Stock_Debt", 1);
	v[11]=VL("Stock_Financial_Assets", 1);
	v[12]=V("Interest_Rate");
	v[13]=V("Interest_Rate_Firm");
...
EQUATION("Flow_Financial_Assets")
/*
Firm Variable
*/
 v[0]=V("Retained_Profits");
