...
*/
	...
	if (v[2]==0)														//if it is class adjustment period 	
		...
		v[3]=VLS(cur, "Avg_Quality_Sector",1);     						//sector average quality in the last period                        
		v[4]=VLS(cur, "Avg_Quality_Sector",(v[1]+1)); 					//sector average quality in the last adjustment period                          
...
*/
	...
	v[0]=VS(cur,"Demand_Met_Sector");                     			 	//percentage of the total demand met by the sector
...
*/
	cur=SEARCH_CNDS(root, "id_consumption_goods_sector", 1);     		//identifies the consumption goods sector
	v[0]=VS(cur,"Demand_Met_Sector");                     			 	//percentage of the total demand met by the sector
	v[1]=VS(cur,"Demand_Met_By_Imports");                 			 	//identifies if classes were capable of importing the amount not mey by the domestic production
...
*/
	...
	v[4]=VS(cur, "Foreign_Price");                                      //sector external price
