...
v[0]=SUMS(cur, "Employment_Sector");
RESULT(v[0])
...
*/
cur = SEARCHS(root, "MACRO");
v[0]=VS(cur, "Aggregate_Inventories");
v[1]=VS(cur, "Price_Index");
v[2]=v[0]/v[1];
RESULT(v[2])
...
*/
cur = SEARCHS(root, "MACRO");
v[0]=VS(cur, "Aggregate_Capital_Stock");
v[1]=VS(cur, "Price_Index");
v[2]=v[0]/v[1];
RESULT(v[2])
