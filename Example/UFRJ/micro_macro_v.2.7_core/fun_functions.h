...
*/
	...
	if (v[0]==1)                                                   			//if it is a intermediate good sector
		...
		CYCLE(cur, "SECTORS")                                        		//CYCLE trought all sectors
		{
			...
			{    
				v[4]=VS(cur1, "Input_Demand_Next_Period");               	//gives the demand for imputs of each firm
...
*/
	...
	{	
		...
		{
			v[3]=VS(cur1, "Demand_Capital_Goods");              //gives the demand for capital goods of each firm
