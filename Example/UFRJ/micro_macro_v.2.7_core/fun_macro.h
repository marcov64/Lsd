...
*/
	...
	{ 
		...
		{
			v[2]=VS(cur1, "Net_Profits");                          	//firm's surplus
...
*/
	...
	CYCLE(cur, "SECTORS")                                      		//CYCLE trought all sectors
	{
		...
		CYCLES(cur, cur1, "FIRMS")                               	//CYCLE trought all firms of the sector
		{
			...
			v[5]=VS(cur1, "RND_Expenses");                         	//firm's rnd expeses, returned as salary to researchers
...
*/
	...
	CYCLE(cur, "SECTORS")
	{
		...
		{
			v[2]=VS(cur1, "Demand_Capital_Goods");
			v[1]=v[1]+v[2];
		}
	v[0]=v[0]+v[1];
	}
...
*/
	...
	{
		v[1]=VS(cur, "Sales_Sector");                      	//sector sales
		v[2]=VS(cur, "Avg_Price");                         	//sector average price
...
*/
	v[0]=SUM("Potential_Employment_Sector");
	v[1]=SUM("Employment_Sector");
	if(v[0]==0)
		v[2]=0;
	else
...
*/
	...
	CYCLE(cur, "SECTORS")
	{
		v[1]=VS(cur, "Exports_Sector");
		v[2]=VS(cur, "Avg_Price");
		v[3]=VS(cur, "Demand_Met_Sector");
		v[4]=v[1]*v[2]*v[3];
		v[0]=v[0]+v[4];
	}
RESULT(v[0])
...
*/
	v[0]=WHTAVE("Extra_Imports", "Foreign_Price");
...
*/
	...
	CYCLE(cur, "SECTORS")
	{
		...
		CYCLES(cur, cur1, "FIRMS")
		{
			v[2]=VS(cur1, "Depreciation_Productive_Capacity");
			v[1]=v[1]+v[2];
		}
		v[0]=v[0]+v[1];
	}
...
*/
	...
	CYCLE(cur, "SECTORS")
	{
		...
		CYCLES(cur, cur1, "FIRMS")
		{
			v[2]=VS(cur1, "Demand_Productive_Capacity_Expansion");
			v[1]=v[1]+v[2];
		}
		v[0]=v[0]+v[1];
	}
...
*/
	...
	CYCLE(cur, "SECTORS")
	{
		...
		CYCLES(cur, cur1, "FIRMS")
		{
			v[2]=VS(cur1, "Demand_Productive_Capacity_Replacement");
			v[1]=v[1]+v[2];
		}
		v[0]=v[0]+v[1];
	}
...
EQUATION("Aggregate_Capital_Stock")
/*
...
EQUATION("Aggregate_Profit_Rate")
/*
