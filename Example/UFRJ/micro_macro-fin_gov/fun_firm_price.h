...
*/
	...
	if(v[2]==0)                                                                      	 //if the rest of the above division is zero (beggining of the year, adjust wages)
		{
		v[4]=LAG_GROWTH(THIS, "Firm_Avg_Productivity", v[1], 1);
...
*/
	...
	if(v[1]==1)                       							//if it is price adjustment period
		{
		v[3]=LAG_AVE(THIS, "Firm_Market_Share", v[2]);				//average market share for the last price frequency periods
		v[4]=LAG_GROWTH(THIS, "Firm_Market_Share", v[2]);  		//market share growth for the last price frequency periods
