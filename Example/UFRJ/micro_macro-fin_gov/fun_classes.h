...
RESULT(LAG_AVE(THIS, "Class_Real_Disposable_Income", V("annual_frequency"),1))

EQUATION("Class_Avg_Nominal_Income")
RESULT(LAG_AVE(THIS, "Class_Nominal_Disposable_Income", V("annual_frequency"),1))
...
v[2]= fmod(T,v[1]);													//divides time period by the class period and takes the rest
...
*/
RESULT(LAG_AVE(THIS, "Class_Debt_Rate", V("annual_frequency"),1))
...
*/
	...
	v[1]=fmod(T,v[0]);
	v[4]=LAG_GROWTH(THIS, "Class_Nominal_Disposable_Income", v[0], 1);
