...
*/
	...
	public static void showFirmMarket(int i) {
		print("F"+f(i,2)+" "+firm[i].tec.label+" "+" birth "+firm[i].birth+" we"+f(firm[i].whenEntered,3)+" sh"+f(firm[i].share,5)+" ebw"+f(firm[i].ebw,4)+" pf"+f(firm[i].profit,5)+" std"+firm[i].stan.label);
	}
	...
	public static void showFirmBookeeping(int i) {
		print("firm "+i+" b"+f(firm[i].bud,5)+" d"+f(firm[i].debt,5)+" rate"+f(firm[i].profitRate,5)+" slopeOfRate"+f(firm[i].slopeOfProfitRate,5));
	}
