#define EQ_USER_CFUNS object *find_nei(object *o,int r, int c, double nrow, double ncol, object *lattice);
...
object * lsd::equation::find_nei(object *o,int r, int c, double nrow, double ncol, object *lattice)
{
