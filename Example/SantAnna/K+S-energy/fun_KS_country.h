...
// workers' wages
v[0] = VS( CAPSECL0, "W1" ) + VS( CONSECL0, "W2" ) + VS( ENESECL0, "We" );
...
v[0] += VLS( CAPSECL0, "Div1", 1 ) + VLS( CONSECL0, "Div2", 1 ) + 
		VLS( ENESECL0, "DivE", 1 ) + VLS( FINSECL0, "DivB", 1 );
...
if ( i >= 1 )									// tax workers' income?
	v[1] += VS( CAPSECL0, "W1" ) + VS( CONSECL0, "W2" ) + VS( ENESECL0, "We" );
...
RECALCS( MACSTAL0, "BadDeb" );					// update bad debt after exits
...
WRITE_EXT( country, eneSta, SEARCH( "Ene" ) );
