...
time_plots <- function( mcData, Adata, mdata, Mdata, Sdata, nExp, nSize, nTsteps,
  ...
  plot_lists( c( "GDP", "I", "D2" ), Adata, mdata, Mdata, Sdata, leg = legends,
              ...
              mrk = transMk, lty = lTypes, xlab = "Time", ylab = "Logs",
  ...
  plot_lists( c( "GDP", "GDP100" ), Adata, mdata, Mdata, Sdata, leg = legends,
              mask = TmaskPlot, nMC = nSize, CI = CI, log0 = TRUE, col = colors,
              mrk = transMk, lty = lTypes, xlab = "Time", ylab = "Log real GDP",
  ...
  for( k in 1 : nExp ) {
    ...
    Adata[[ k ]][ "GtrainGDP" ] <- Adata[[ k ]]$Gtrain / Adata[[ k ]]$GDPnom
    mdata[[ k ]][ "GtrainGDP" ] <- mdata[[ k ]]$Gtrain / Adata[[ k ]]$GDPnom
    Mdata[[ k ]][ "GtrainGDP" ] <- Mdata[[ k ]]$Gtrain / Adata[[ k ]]$GDPnom
    Sdata[[ k ]][ "GtrainGDP" ] <- Sdata[[ k ]]$Gtrain / Adata[[ k ]]$GDPnom
  }

  plot_lists( c( "TaxGDP", "GGDP", "GbailGDP", "GtrainGDP" ), Adata, mdata,
              Mdata, Sdata, leg = legends, mask = TmaskPlot, nMC = nSize,
  ...
  plot_lists( "wAvgReal", Adata, mdata, Mdata, Sdata, leg = legends,
  ...
  plot_lists( "wGini", Adata, mdata, Mdata, Sdata, leg = legends,
  ...
  plot_lists( c( "sTavg", "sVavg" ), Adata, mdata, Mdata, Sdata, leg = legends,
              mask = TmaskPlot, nMC = nSize, CI = CI, mrk = transMk, col = colors,
              lty = lTypes, xlab = "Time", ylab = "Average worker skills level",
              tit = "Workers' skills",
              subtit = paste( "MC runs =", nSize ),
  ...
  plot_lists( c( "A", "A1", "A2" ), Adata, mdata, Mdata, Sdata, leg = legends,
              mask = TmaskPlot, nMC = nSize, CI = CI, log = TRUE, mrk = transMk,
              col = colors, lty = lTypes, xlab = "Time",
  ...
  plot_lists( c( "A2preChg", "A2posChg" ), Adata, mdata, Mdata, Sdata, leg = legends,
              mask = TmaskPlot, nMC = nSize, CI = CI, log0 = TRUE, mrk = transMk,
              col = colors, lty = lTypes, xlab = "Time",
  ...
  plot_lists( "f2posChg", Adata, mdata, Mdata, Sdata, leg = legends,
              mask = TmaskPlot, nMC = nSize, CI = CI, mrk = transMk, col = colors,
              lty = lTypes, xlab = "Time",
