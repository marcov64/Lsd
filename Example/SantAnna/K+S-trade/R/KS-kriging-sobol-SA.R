...
caption   <- "K+S Kriging-Sobol DoE analysis"# caption for logs
repName   <- ""                     # report files base name (if "" same as baseName)
datFilSfx <- "krig"                 # data file suffix
...
covModel  <- 0                      # 1=Matern5/2/2=Matern3/2/3=Gauss/4=expon/5=pwr exp
...
# !diagnostics suppress = sobol.decomposition.lsd, kriging.model.lsd, persp3d
...
tryCatch( {   # enter error handling mode so PDF can be closed in case of error
  ...
  # ====== Max/min of the kriging meta-model parameters ======
