...
time_plots <- function( mcData, Pdata, Xdata, mdata, Mdata, Sdata, cdata, Cdata,
  ...
  plot_lists( c( "GDPreal", "Creal", "Ireal" ), Xdata, mdata, Mdata, cdata, Cdata,
  ...
  plot_lists( c( "GDPnom", "C", "Inom" ), Xdata, mdata, Mdata, cdata, Cdata,
              DCdata = DCdata, leg = legends, mask = TmaskPlot, nMC = nSize,
              CI = CI, log0 = TRUE, col = colors, mrk = transMk, lty = lTypes,
              xlab = "Time", ylab = "Log nominal (current prices) aggregate",
              tit = "Nominal GDP, consumption and investment",
              subtit = subtit,
              leg2 = c( "GDP", "Consumption", "Investment" ) )
  ...
  plot_lists( "DefGDP", Pdata, mdata, Mdata, cdata, Cdata,
              ...
              subtit = paste( subtitbase, Ptag[ "DefGDP" ], cntLeg ),
              trend = "loess" )
  ...
  plot_lists( "DebGDP", Pdata, mdata, Mdata, cdata, Cdata,
              ...
              tit = "Government debt",
              subtit = paste( subtitbase, Ptag[ "DebGDP" ], cntLeg ),
              trend = "linear" )
  ...
  plot_lists( c( "QcU", "Lpart" ), Xdata, mdata, Mdata, cdata, Cdata,
              DCdata = DCdata, leg = legends, mask = TmaskPlot, nMC = nSize,
              CI = CI, mrk = transMk, col = colors, lty = lTypes, mCnt = mCnt,
              xlab = "Time",
  ...
  plot_lists( c( "WGDP", "BonCgdp" ), Xdata, mdata, Mdata, cdata, Cdata,
              ...
              mCnt = mCnt, xlab = "Time",
              ylab = "Total wages and bonus on GDP",
  ...
  plot_lists( c( "SavLux", "DcLux" ), Xdata, mdata, Mdata, cdata, Cdata,
              ...
              subtit = subtit, leg2 = c( "Savings", "Consumption" ) )
  ...
  plot_lists( c( "g1front", "g1max" ), Xdata, mdata, Mdata, cdata, Cdata,
              ...
              tit = "Technological frontier", subtit = subtit,
  ...
  plot_lists( c( "nCavgBas", "nCavgLux" ), Xdata, mdata, Mdata, cdata, Cdata,
              ...
              tit = "Product newness", subtit = subtit,
              leg2 = c( "Basic goods", "Luxury goods" ) )


  # ------ Market share of post-change firms ------

  plot_lists( "fCposChg", Pdata, mdata, Mdata, cdata, Cdata,
              DCdata = DCdata, leg = legends, mask = TmaskPlot, nMC = nSize,
              CI = CI, mrk = transMk, col = colors, lty = lTypes, mCnt = mCnt,
  ...
  plot_lists( c( "EXk", "EXc" ), Xdata, mdata, Mdata, cdata, Cdata,
              ...
              tit = "Entry-exit turbulence index", subtit = subtit,
              leg2 = c( "Capital-good sector", "Consumption-good sector" ),
              trend = "linear" )
