  ...
  for( k in 1 : nExp ){             # do for each experiment
    ...
    for( l in 1 : nSize ) {                        # for all MC samples (files)
      ...
      for( i in ( 1 + prdWnd ) : ( nTstat - warmUp + 1 ) ) {  # all time steps
        ...
        for( j in 1 : nrow( fd ) ) {
          if( ( is.na( fd$postChg[ j ] ) && is.na( fd$postChg.1[ j ] ) ) ||
              ( ( ! is.na( fd$postChg[ j ] ) && ! is.na( fd$postChg.1[ j ] ) )
                && fd$postChg[ j ] != fd$postChg.1[ j ] ) ||
              ( is.na( fd$f2[ j ] ) && is.na( fd$f2.1[ j ] ) ) )
            stop( "Firm data matrix is inconsistent" )

          if( ( is.na( fd$postChg[ j ] ) ) )
            fd$postChg[ j ] <- fd$postChg.1[ j ]
        ...
        prdDec[[ k ]][[ l ]]$nF.pre[ j ] <-
          count( ! is.na( fd$lA2[ fd$postChg == 0 ] ) ) / nPer
        prdDec[[ k ]][[ l ]]$nF.pos[ j ] <-
          count( ! is.na( fd$lA2[ fd$postChg == 1 ] ) ) / nPer
        prdDec[[ k ]][[ l ]]$nF.inc[ j ] <-
          count( ! is.na( fd$lA2[ fd$type == 2 ] ) ) / nPer
        prdDec[[ k ]][[ l ]]$nF.inc.pre[ j ] <-
          count( ! is.na( fd$lA2[ fd$postChg == 0 & fd$type == 2 ] ) ) / nPer
        prdDec[[ k ]][[ l ]]$nF.inc.pos[ j ] <-
          count( ! is.na( fd$lA2[ fd$postChg == 1 & fd$type == 2 ] ) ) / nPer
        ...
        prdDec[[ k ]][[ l ]]$lA2.pre.1[ j ] <-
          sum( fd$f2.1[ fd$postChg == 0 ] * fd$lA2.1[ fd$postChg == 0 ],
               na.rm = TRUE )
        prdDec[[ k ]][[ l ]]$lA2.pre[ j ] <-
          sum( fd$f2[ fd$postChg == 0 ] * fd$lA2[ fd$postChg == 0 ], na.rm = TRUE )
        prdDec[[ k ]][[ l ]]$delta.lA2.pre[ j ] <-
          prdDec[[ k ]][[ l ]]$lA2.pre[ j ] - prdDec[[ k ]][[ l ]]$lA2.pre.1[ j ]

        prdDec[[ k ]][[ l ]]$lA2.pos.1[ j ] <-
          sum( fd$f2.1[ fd$postChg == 1 ] * fd$lA2.1[ fd$postChg == 1 ], na.rm = TRUE )
        prdDec[[ k ]][[ l ]]$lA2.pos[ j ] <-
          sum( fd$f2[ fd$postChg == 1 ] * fd$lA2[ fd$postChg == 1 ], na.rm = TRUE )
        ...
        prdDec[[ k ]][[ l ]]$lA2.inc.pre.1[ j ] <-
          sum( fd$f2.1[ fd$postChg == 0 & fd$type == 2 ] *
                 fd$lA2.1[ fd$postChg == 0 & fd$type == 2 ], na.rm = TRUE )
        prdDec[[ k ]][[ l ]]$lA2.inc.pre[ j ] <-
          sum( fd$f2[ fd$postChg == 0 & fd$type == 2 ] *
                 fd$lA2[ fd$postChg == 0 & fd$type == 2 ], na.rm = TRUE )
        prdDec[[ k ]][[ l ]]$delta.lA2.inc.pre[ j ] <-
          prdDec[[ k ]][[ l ]]$lA2.inc.pre[ j ] - prdDec[[ k ]][[ l ]]$lA2.inc.pre.1[ j ]

        prdDec[[ k ]][[ l ]]$lA2.inc.pos.1[ j ] <-
          sum( fd$f2.1[ fd$postChg == 1 & fd$type == 2 ] *
                 fd$lA2.1[ fd$postChg == 1 & fd$type == 2 ], na.rm = TRUE )
        prdDec[[ k ]][[ l ]]$lA2.inc.pos[ j ] <-
          sum( fd$f2[ fd$postChg == 1 & fd$type == 2 ] *
                 fd$lA2[ fd$postChg == 1 & fd$type == 2 ], na.rm = TRUE )
        ...
        prdDec[[ k ]][[ l ]]$B.pre[ j ] <-
          sum( fd$delta.f2[ fd$type == 2 & fd$postChg == 0 ] *
                 ( fd$lA2.1[ fd$type == 2 & fd$postChg == 0 ] -
                     prdDec[[ k ]][[ l ]]$lA2.pre.1[ j ] ),
               na.rm = TRUE )
        prdDec[[ k ]][[ l ]]$B.pos[ j ] <-
          sum( fd$delta.f2[ fd$type == 2 & fd$postChg == 1 ] *
                 ( fd$lA2.1[ fd$type == 2 & fd$postChg == 1 ] -
                     prdDec[[ k ]][[ l ]]$lA2.pos.1[ j ] ),
               na.rm = TRUE )
        prdDec[[ k ]][[ l ]]$W.pre[ j ] <-
          sum( fd$f2.1[ fd$type == 2 & fd$postChg == 0 ] *
                 fd$delta.lA2[ fd$type == 2 & fd$postChg == 0 ] ,
               na.rm = TRUE )
        prdDec[[ k ]][[ l ]]$W.pos[ j ] <-
          sum( fd$f2.1[ fd$type == 2 & fd$postChg == 1 ] *
                 fd$delta.lA2[ fd$type == 2 & fd$postChg == 1 ] ,
               na.rm = TRUE )
        prdDec[[ k ]][[ l ]]$C.pre[ j ] <-
          sum( fd$delta.f2[ fd$type == 2 & fd$postChg == 0 ] *
                 fd$delta.lA2[ fd$type == 2 & fd$postChg == 0 ] ,
        ...
        prdDec[[ k ]][[ l ]]$C.pos[ j ] <-
          sum( fd$delta.f2[ fd$type == 2 & fd$postChg == 1 ] *
               ...
               na.rm = TRUE )
        prdDec[[ k ]][[ l ]]$N.pre[ j ] <-
          sum( fd$f2[ fd$type == 1 & fd$postChg == 0 ] *
                 ( fd$lA2[ fd$type == 1 & fd$postChg == 0 ] -
                     prdDec[[ k ]][[ l ]]$lA2.pre.1[ j ] ),
               na.rm = TRUE )
        prdDec[[ k ]][[ l ]]$N.pos[ j ] <-
          sum( fd$f2[ fd$type == 1 & fd$postChg == 1 ] *
                 ( fd$lA2[ fd$type == 1 & fd$postChg == 1 ] -
                     prdDec[[ k ]][[ l ]]$lA2.pos.1[ j ] ),
               na.rm = TRUE )
        prdDec[[ k ]][[ l ]]$X.pre[ j ] <-
          sum( fd$f2.1[ fd$type == 3 & fd$postChg == 0 ] *
                 ( fd$lA2.1[ fd$type == 3 & fd$postChg == 0 ] -
                     prdDec[[ k ]][[ l ]]$lA2.pre.1[ j ] ),
               na.rm = TRUE )
        prdDec[[ k ]][[ l ]]$X.pos[ j ] <-
          sum( fd$f2.1[ fd$type == 3 & fd$postChg == 1 ] *
                 ( fd$lA2.1[ fd$type == 3 & fd$postChg == 1 ] -
                     prdDec[[ k ]][[ l ]]$lA2.pos.1[ j ] ),
               na.rm = TRUE )
